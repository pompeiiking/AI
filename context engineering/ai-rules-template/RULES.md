...
> **本文件 + `skills/` 目录构成完整的AI开发规范模板。**
> 复制到任何新项目根目录，AI首次阅读后自动引导转化为项目专属规范。
> 版本: 2.0 | 创建日期: 2026-03-04

<!-- AI通过此标识判断当前是模板还是已转化的项目专属规范 -->
<!-- 转化完成后改为: TEMPLATE_STATUS: INITIALIZED:[项目名] -->
